...
// exceptedWidth is such as padding margin and etc to ignore with the same cross width
  setTimeout(() => {
    ...
    var s61Day = Math.floor((new Date() * 1 - new Date(2023, 8, 23) * 1) / 86400000),// 1 mehr 1402
            ...
            s61ls = localStorage, s61b = "/notrex/v1/lib_assistant/",
            ...
            /*change my site in future*/s61Server = "https://notrex.ir/", s61ProductHash = s61hashCode(s61url),
...
//s61Server = s61SiteBase; s61vBase = "/notrex/v1/",
...
//console.log("s61WidgetPrograms 2",s61WidgetPrograms);
        ...
        if (s61WidgetPrograms.length < 1) {
            s61Hide(s61a);
//                s61Hide(s61v);
            s61n.textContent = (j.msg ? j.msg : (j.status === -2 ? "لایو ناترکس غیر فعال است" : "برنامه ای قرار نگرفته است"));
