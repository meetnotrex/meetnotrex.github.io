            ...
            if (i1 < 0) {
                ...
                if (typeof el === 'object') {
                    ...
                    if (!check) {
                        ...
                        flag = false;
                        toast.error("در متن عنوان صفحه حروف غیر مجاز پیدا شده : " + check[1]);
                    }
                    check = isInputValidate(link);
                    if (!check) {
                        flag = false;
                        ...
                        flag = false;
                        toast.error("در لینک صفحه حروف غیر مجاز پیدا شده : " + check[1]);
                    }
                    if (flag) {
...
//                i1 = slice.indexOf("<img src=", d);
//                i2 = slice.indexOf(">", i1);
////                        monsole.log("img   d: " + d, "i1: " + i1, "i2: " + i2);
//                if (i1 > d) {
//                    processPackSlice(res, slice.substring(d, i1).replace(/<br>/gim, ""), isCorrectStructure);
//                }
//                if (i1 < 0) {
...
//                    flag = true;
//                    var el = new DOMParser().parseFromString(str, 'text/html').body.firstChild;
////                    monsole.log('getCleanSlice str : ',str,new DOMParser().parseFromString(str, 'text/html').body.firstChild);
//                    monsole.log("el : ", el, "typeof el : ", typeof el, 'el len; ', el.length, "str : " + str);
//                    if (typeof el === 'object') {
//                        src = el.src;
//                        title = el.dataset.title;
                                ...
                                getCamAndMicPermission(function (isAllowed) {
                                    if (isAllowed) {
                                        ...
                                        g("#media_help").onclick = function () {
                                            openLinkInNewTab("https://notrex.ir/etc/help-start-to-talk-by-customer.html");
                                        }
                                    }
                                }, false);
                            }
                            ...
                            if (flag) {
                                ...
                                getCamAndMicPermission(function (isAllowed) {
                                    if (isAllowed) {
                                        ...
                                        showDialog(j);
                                        g("#media_help").onclick = function () {
                                            openLinkInNewTab("https://notrex.ir/help/media_permission");
                                        }
                                    }
                                }, true);
                            }
